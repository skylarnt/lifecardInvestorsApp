            ...
            <b-col md="4" xl="4" sm="12" xs="12">
                ...
                <div class="card">
                    ...
                    <div class="small-box">
                        <div class="d-flex inner">
                        <div>
                            <h3>{{analytics.property_bought ? analytics.property_bought : 0}}</h3>
                            <p>Property Bought</p>
                        </div>
            ...
            <b-col md="4" xl="4" sm="12" xs="12">
                ...
                <div class="card">
                    ...
                    <div class="small-box">
                        <div class="d-flex inner">
                        <div>
                            <h3>{{analytics.approved_request ? analytics.approved_request : 0}}</h3>
...
export default {
  ...
  methods: {
    ...
    fetchData(page=1) {
      this.loading = true
      this.$api
      .post(this.dynamic_route('/requests/dashboard_analytics'))
      .then(res => {
          this.loading=false;
