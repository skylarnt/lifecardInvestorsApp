<template>
    <v-app class="p-4">
        <b-row>
            <b-col>
                <Widget title="" customHeader>
                    <h5 class="d-inline-block">Sell <span class='fw-semi-bold'>Property</span></h5>
        ...
        <b-modal :title="`Attach ${current.name} to a marketer`" id="attach" hide-footer size="xl">
...
export default {
    components: { Widget, VueElementLoading, laravelVuePagination, AttachMarketer,ManageMarketers },
    data() {
        return {
            status_id: 0,
            del_id: 0,
